// import DocumentTFIDF from './DocumentTFIDF';
...
//   _K1: number;
//   _b: number;
//   _documents: Map<string, DocumentTFIDF>;
//   _collectionFrequencies: Map<string, number> | null;
//   _collectionFrequencyWeights: Map<string, number> | null;
//   _documentVectors: Map<string, Map<string, number>> | null;
...
//   constructor(names: string[], texts: string | any[], useDefaultStopwords = true, customStopwords = [], K1 = 2.0, b = 0.75) {
//     this._stopwords = new Stopwords(useDefaultStopwords, customStopwords);
//     this._K1 = K1;
//     this._b = b;
//     this._documents = new Map();
//     for (let i = 0; i < texts.length; i++) {
//       this._documents.set(names[i], new DocumentTFIDF(texts[i]));
//     }
...
//   private _calculateCollectionFrequencies() {
...
//       if (document instanceof DocumentTFIDF) {
//         const uniqueTerms = document.getUniqueTerms();
//         if (uniqueTerms) {
//           uniqueTerms
//             .filter(t => !this._stopwords.includes(t))
//             .forEach(term => {
//               const n = this._collectionFrequencies!.get(term) || 0;
...
//   getCollectionFrequency(term: string) {
//     this._calculateCollectionFrequencies();
...
//     getCommonTerms(identifier1: string, identifier2: string, maxTerms = 10): [string, number][] {
...
//         .map(([term, cw]: [string, number]) => {
//           const term2 = vector2.get(term);
//           return [term, term2 ? cw * (term2 as number) : 0];
//         })
